...
add template engine using ejs, split code nav and head, add new connection using mongoose, render data from mongoDB, post request data, get data by id, add script nodemon for dev.
